...
void ASwashCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Melee Attacking
		//EnhancedInputComponent->BindAction(MeleeAttackAction, ETriggerEvent::Triggered, this, &ASwashCharacter::StartMeleeAttack);

		//Ranged Attacking
		//EnhancedInputComponent->BindAction(RangedAttackAction, ETriggerEvent::Triggered, this, &ASwashCharacter::StartRangedAttack);
...
//void ASwashCharacter::StartMeleeAttack(const FInputActionValue& Value) 
//{
	//...
//}

//void ASwashCharacter::StartRangedAttack(const FInputActionValue& Value) 
//{
	//...
//}
